...
_ICONS = {
    ...
    "dns": (
        ...
        'viewBox="0 0 24 24">'
        '<!-- цилиндр БД (верхний) -->'
        '<ellipse cx="12" cy="5" rx="7.5" ry="3" fill="{c}"/>'
        '<path fill="{c}" d="M4.5,5v4c0,1.66 3.36,3 7.5,3s7.5,-1.34 '
        '7.5,-3V5c0,1.66 -3.36,3 -7.5,3S4.5,6.66 4.5,5z"/>'
        '<ellipse cx="12" cy="5" rx="7.5" ry="2.3" fill="#ffffff" '
        'opacity="0.22"/>'
        '<!-- цилиндр БД (нижний) -->'
        '<ellipse cx="12" cy="12" rx="7.5" ry="3" fill="{c}" '
        'opacity="0.78"/>'
        '<path fill="{c}" opacity="0.78" d="M4.5,12v4c0,1.66 3.36,3 '
        '7.5,3s7.5,-1.34 7.5,-3v-4c0,1.66 -3.36,3 -7.5,3'
        'S4.5,13.66 4.5,12z"/>'
        '<ellipse cx="12" cy="12" rx="7.5" ry="2.3" fill="#ffffff" '
        'opacity="0.16"/>'
        '<!-- световой блик -->'
        '<ellipse cx="8.5" cy="4.2" rx="2.5" ry="1" fill="#ffffff" '
        'opacity="0.2" transform="rotate(-8 8.5 4.2)"/>'
        '</svg>'
    ),
    "account_tree": (
        '<svg xmlns="http://www.w3.org/2000/svg" width="{s}" height="{s}" '
