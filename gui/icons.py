...
_ICONS = {
    ...
    "dns": (
        ...
        '<circle fill="#4ade80" cx="5.5" cy="6.5" r="1.2"/>'
        '<ellipse cx="14.5" cy="6" rx="4.5" ry="1.8" fill="#ffffff" '
        'opacity="0.35"/>'
        '<path fill="#ffffff" opacity="0.35" d="M10,6v2c0,1 '
        '2.01,1.8 4.5,1.8s4.5,-0.8 4.5,-1.8V6C19,6.8 16.99,7.8 '
        '14.5,7.8S10,6.8 10,6z"/>'
        '<ellipse cx="14.5" cy="6" rx="4.5" ry="1.5" fill="{c}" '
        'opacity="0.5"/>'
        ...
        '<rect x="3" y="13" width="18" height="0.6" rx="0.3" '
        'fill="#ffffff" opacity="0.18"/>'
        '<circle fill="#4ade80" cx="5.5" cy="16.5" r="1.2"/>'
        '<rect x="10" y="15.5" width="8" height="0.7" rx="0.35" '
        'fill="#ffffff" opacity="0.5"/>'
        '<rect x="10" y="17" width="8" height="0.7" rx="0.35" '
        'fill="#ffffff" opacity="0.5"/>'
        '<rect x="10" y="18.5" width="8" height="0.7" rx="0.35" '
        'fill="#ffffff" opacity="0.5"/>'
        '</svg>'
    ),
    "account_tree": (
