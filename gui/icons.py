...
_ICONS = {
    ...
    "dns": (
        ...
        'viewBox="0 0 24 24">'
        '<!-- серверный шкаф: 3 секции -->'
        '<path fill="{c}" d="M20,2H4C2.9,2 2,2.9 2,4v4c0,1.1 0.9,2 '
        '2,2h16c1.1,0 2,-0.9 2,-2V4C22,2.9 21.1,2 20,2z"/>'
        '<path fill="{c}" d="M20,11H4c-1.1,0 -2,0.9 -2,2v4c0,1.1 0.9,2 '
        '2,2h16c1.1,0 2,-0.9 2,-2v-4C22,11.9 21.1,11 20,11z"/>'
        '<path fill="{c}" d="M20,20H4c-1.1,0 -2,0.9 -2,2v1c0,0.6 '
        '0.4,1 1,1h18c0.6,0 1,-0.4 1,-1v-1C22,20.9 21.1,20 20,20z"/>'
        '<!-- свечение/ highlights -->'
        '<rect x="3" y="3" width="18" height="0.6" rx="0.3" '
        'fill="#ffffff" opacity="0.18"/>'
        '<rect x="3" y="12" width="18" height="0.6" rx="0.3" '
        'fill="#ffffff" opacity="0.18"/>'
        '<!-- индикаторы (LEDs) -->'
        '<circle fill="#4ade80" cx="5.5" cy="6" r="1.2"/>'
        '<circle fill="#4ade80" cx="5.5" cy="15" r="1.2"/>'
        '<!-- цилиндр БД на верхней секции -->'
        '<ellipse cx="14.5" cy="5.5" rx="4.5" ry="1.8" fill="#ffffff" '
        'opacity="0.35"/>'
        '<path fill="#ffffff" opacity="0.35" d="M10,5.5v2c0,1 '
        '2.01,1.8 4.5,1.8s4.5,-0.8 4.5,-1.8v-2C19,6.3 16.99,7.1 '
        '14.5,7.1S10,6.3 10,5.5z"/>'
        '<ellipse cx="14.5" cy="5.5" rx="4.5" ry="1.5" fill="{c}" '
        'opacity="0.5"/>'
        '<!-- вентиляция на нижней секции -->'
        '<rect x="10" y="14" width="8" height="0.7" rx="0.35" '
        'fill="#ffffff" opacity="0.5"/>'
        '<rect x="10" y="15.5" width="8" height="0.7" rx="0.35" '
        'fill="#ffffff" opacity="0.5"/>'
        '<rect x="10" y="17" width="8" height="0.7" rx="0.35" '
        'fill="#ffffff" opacity="0.5"/>'
        '</svg>'
    ),
    "account_tree": (
        ...
        'fill="#ffffff" opacity="0.18"/>'
        '<!-- индикаторы (LEDs) -->'
        '<circle fill="#e879f9" cx="5.5" cy="6" r="1.2"/>'
        '<circle fill="#e879f9" cx="5.5" cy="15" r="1.2"/>'
        '<!-- узлы дерева (ветвление) на верхней секции -->'
        '<circle cx="14" cy="4.5" r="1.4" fill="#ffffff" opacity="0.45"/>'
        '<circle cx="18" cy="6.5" r="1.4" fill="#ffffff" opacity="0.45"/>'
        '<circle cx="10" cy="6.5" r="1.4" fill="#ffffff" opacity="0.45"/>'
        '<path stroke="#ffffff" stroke-width="0.7" fill="none" '
        'opacity="0.4" d="M14,5.9v1.5 M14,6.5l-2.6,0 M14,6.5l2.6,0"/>'
        '<!-- шестерёнка на нижней секции -->'
        '<circle cx="14" cy="15.5" r="2.8" fill="none" '
        'stroke="#ffffff" stroke-width="0.8" opacity="0.35"/>'
        '<circle cx="14" cy="15.5" r="1.2" fill="#ffffff" opacity="0.35"/>'
        '<!-- зубцы шестерёнки -->'
        '<rect x="13.2" y="12" width="1.6" height="1.2" rx="0.4" '
        'fill="#ffffff" opacity="0.3"/>'
        '<rect x="13.2" y="17.8" width="1.6" height="1.2" rx="0.4" '
        'fill="#ffffff" opacity="0.3"/>'
        '<rect x="10.5" y="14.7" width="1.2" height="1.6" rx="0.4" '
        'fill="#ffffff" opacity="0.3"/>'
        '<rect x="16.3" y="14.7" width="1.2" height="1.6" rx="0.4" '
        'fill="#ffffff" opacity="0.3"/>'
        '</svg>'
    ),
    "server": (
