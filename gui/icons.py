...
_ICONS = {
    ...
    "error": (
        "M12,2C6.48,2 2,6.48 2,12s4.48,10 10,10 10,-4.48 10,-10S17.52,2 12,2z"
        "M13,17h-2v-2h2v2zM13,13h-2V7h2v6z"
    ),
    "warning": (
        "M1,21h22L12,2L1,21zM13,18h-2v-2h2v2zM13,14h-2v-4h2v4z"
    ),
    "help": (
        "M12,2C6.48,2 2,6.48 2,12s4.48,10 10,10 10,-4.48 10,-10S17.52,2 12,2z"
        "M13,19h-2v-2h2v2zM15.07,11.25l-0.9,0.92C13.45,12.9 13,13.5 13,15h-2v-0.5"
        "c0,-1.1 0.45,-2.1 1.17,-2.83l1.24,-1.26C13.74,10.09 14,9.75 14,9.5c0,-1.1"
        "-0.9,-2 -2,-2s-2,0.9 -2,2H8c0,-2.21 1.79,-4 4,-4s4,1.79 4,4c0,0.88 -0.36,"
        "1.68 -0.93,2.25z"
    ),
    "stop": (
        "M6,6h12v12H6z"
    ...
    "shrink": (
        "M5,13h6v6l-2.29,-2.29 -3.42,3.42 -1.42,-1.42 3.42,-3.42L5,13z"
        "M19,11h-6V5l2.29,2.29 3.42,-3.42 1.42,1.42 -3.42,3.42L19,11z"
    ),
    "sqlite": (
